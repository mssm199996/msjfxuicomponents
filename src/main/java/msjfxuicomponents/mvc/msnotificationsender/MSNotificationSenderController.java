...
public class MSNotificationSenderController implements Initializable, ResetController {
	...
	private MSServer notificationsServer = new MSServer(56489);

	private MSClient notificationsClient = new MSClient(56489) {
	...
	private MSClient notifiarsDiscover = new MSClient(56489) {
