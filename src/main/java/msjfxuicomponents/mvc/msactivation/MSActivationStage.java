...
public class MSActivationStage extends SimpleStageType<MSActivationController> {
	...
	public MSActivationStage(String title, CopyrightHandler serialNumberCopyrightHandler) {
		super(title, "/msjfxuicomponents/mvc/msactivation/MSActivation.fxml");

		this.initModality(Modality.APPLICATION_MODAL);
		this.setAlwaysOnTop(true);
		this.setResizable(false);
		this.getController().setCopyrightHandler(serialNumberCopyrightHandler);
