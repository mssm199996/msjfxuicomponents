...
public abstract class ListeCategorizersController<C extends ICategorizer> extends SearchController<C>
	...
	@FXML
	protected JFXTextField nomCategorizer;

	@FXML
	protected TableView<C> tableCategorizers;
	...
	@FXML
	private MenuButton shortcutsDescriptionMenuButton;
	...
	void deleteCategorizer() {
		...
		if (categorizer != null) {
			if (MSJFXUIComponentsHolder.MS_ALERT_DISPLAYER.displayConfirmationAlert(this.getNomGestion(),
				...
				this.onDeleteSuccessfulled(categorizer);
	...
	public MenuButton getKeyShortcutDescriber() {
		return this.shortcutsDescriptionMenuButton;
	}

	@Override
	public LinkedHashMap<String, String> fromKeyCodeToDescriptionsShortcutsMap() {
		LinkedHashMap<String, String> result = new LinkedHashMap<>();
		result.put("F1", this.getTextAddButton());
		result.put("Suppr", this.getTextDeleteButton());
	...
	public void onDeleteSuccessfulled(C categorizer) {
